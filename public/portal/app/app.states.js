    ...
    .config([
        ...
        function ($stateProvider, $urlRouterProvider) {
            ...
            // -- RESTRICTED --
                ...
                .state("restricted.products.index", {
                    url: "/index",
                    templateUrl: 'app/components/products/products_listView.html',
                    controller: 'products_listCtrl',
                    resolve: {
                        products_data: function($http){
                            return $http({method: 'GET', url: '/api/v1/products.json'})
                                .then(function (data) {
                                    return data.data;
                                });
                        },
                        deps: ['$ocLazyLoad', function($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                'lazy_pagination',
                                'app/components/products/products_listController.js'
                            ], { serie: true } );
                        }]
                    },
                    data: {
                ...
                .state("restricted.products.details", {
                    url: "/details/:product_id",
                    templateUrl: 'app/components/products/product_detailsView.html',
                    controller: 'productCtrl',
                    resolve: {
                        product: ['$http','$stateParams', function($http, $stateParams) {
                             return $http.get('/api/v1/products/' + $stateParams.product_id)
                                    .then(function(data) { return data.data; });
                         }],
                        deps: ['$ocLazyLoad', function($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                'app/components/products/productController.js'
                            ]);
                        }]
                    },
                    data: {
                ...
                .state("restricted.products.product_edit", {
                    url: "/product_edit",
                    templateUrl: 'app/components/products/product_editView.html',
                    controller: 'productCtrl',
                    resolve: {
                        deps: ['$ocLazyLoad', function($ocLazyLoad) {
                            return $ocLazyLoad.load([
