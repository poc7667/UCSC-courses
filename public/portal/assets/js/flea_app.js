...
var fleaApp = angular.module('fleaApp', [
    'ui.router',
    'oc.lazyLoad',
    'ngSanitize',
    'ngRetina',
...
// breadcrumbs
fleaApp.config(function($breadcrumbProvider) {
...
fleaApp
    .run([
        ...
        function ($rootScope, $state, $stateParams,$http,$window, $timeout,variables) {
            ...
            // set theme
            $rootScope.main_theme = "app_theme_i"
