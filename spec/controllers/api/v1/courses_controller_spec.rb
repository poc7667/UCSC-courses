...
RSpec.describe Api::V1::CoursesController, type: :controller do
  ...
  # Api::V1::CoursesController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET #new" do
    it "assigns a new api_v1 as @api_v1" do
      ...
      expect(assigns(:api_v1)).to be_a_new(Course)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created api_v1 as @api_v1" do
        post :create, {:api_v1 => valid_attributes}, valid_session
        expect(assigns(:api_v1)).to be_a(Course)
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested api_v1" do
        course = Course.create! valid_attributes
        put :update, {:id => course.to_param, :api_v1 => new_attributes}, valid_session
        course.reload
      ...
      it "assigns the requested api_v1 as @api_v1" do
        course = Course.create! valid_attributes
        put :update, {:id => course.to_param, :api_v1 => valid_attributes}, valid_session
        expect(assigns(:api_v1)).to eq(course)
      end
    ...
    context "with invalid params" do
      it "assigns the api_v1 as @api_v1" do
        course = Course.create! valid_attributes
        put :update, {:id => course.to_param, :api_v1 => invalid_attributes}, valid_session
        expect(assigns(:api_v1)).to eq(course)
      end
